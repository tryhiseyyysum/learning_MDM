...
from lib.evaluators.evaluator_wrapper import EvaluatorMDMWrapper
from lib.evaluators import eval_humanml
...
class TrainLoop:
    def __init__(self, args, train_platform, model, diffusion, data):
        ...
        if args.dataset in ['kit', 'humanml3d'] and args.eval_during_training:
