...
import numpy as np
from . import yacs
from lib.utils.parser_util import train_args
...
cfg.network_module = 'lib.datasets.dtu.neus'
...
# data = make_data_loader(name=cfg.args.dataset, batch_size=cfg.args.batch_size, num_frames=cfg.args.num_frames)
...
parser.add_argument("--cfg_file", default="configs/mdm/humanml3d.yaml", type=str)
...
cfg.args2=train_args()

cfg.data = make_data_loader(cfg)
